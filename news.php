...
?>
    ...
    <li ><a href="students.php" id="forStudents" class="unActive">За Студентите</a></li>
    ...
    <div id="newsBox">
        <div id="fullNews">
            ...
            if($isHavePDF == '1'){
            ?>
            <a href="http://mmu2.uctm.edu/nstudsavet/docs/<?php echo $pdfPath;?>" id="pdfHref"><?php echo $hrefPdf;?></a>
            <?php
            }
            ?>
